	...
	For i = 0 to MAX_LISTBOXES-1
		If Not Gui_ListBox_Exists[i] Then
			...
			If OS = "WINDOWS" Then
				...
				LoadImage(GUI_SCROLLDOWN_IMAGE, Dir+"\\gui_gfx\\scroll_down.png")
				GUI_SCROLLUP_IMAGE = Gui_GetFreeImage
				LoadImage(GUI_SCROLLUP_IMAGE, Dir+"\\gui_gfx\\scroll_up.png")
				GUI_PAGEDOWN_IMAGE = Gui_GetFreeImage
				LoadImage(GUI_PAGEDOWN_IMAGE, Dir+"\\gui_gfx\\page_down.png")
				GUI_PAGEUP_IMAGE = Gui_GetFreeImage
				LoadImage(GUI_PAGEUP_IMAGE, Dir+"\\gui_gfx\\page_up.png")				
			Else
				GUI_SCROLLDOWN_IMAGE = Gui_GetFreeImage
				LoadImage(GUI_SCROLLDOWN_IMAGE, Dir+"/gui_gfx/scroll_down.png")
				GUI_SCROLLUP_IMAGE = Gui_GetFreeImage
...
Sub Gui_PollEvents()
	...
	Else
		For i = 0 to MAX_GUI_ELEMENTS-1
			If Gui_Element_Active[i] And Gui_Element_Active[ Gui_Element_Parent[i] ] And Gui_Element_Window[ Gui_Element_Parent[i] ] = ActiveWindow Then
