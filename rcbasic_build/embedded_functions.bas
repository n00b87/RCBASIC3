...
function Replace$(src$, rpc$, pos)
function ReplaceSubstr$(src$, tgt$, rpc$)
...
'More stuff - CanvasClip now has flag, SetWindowIcon(win, slot), DrawImage_Flip(slot, x, y, h, v), DrawImage_Flip_Ex(slot, x, y, src_x, src_y, src_w, src_h, h, v)
'Clipboard
