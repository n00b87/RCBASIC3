...
#define GETDESKTOPDISPLAYMODE_INDEX num_var[0].nid_value[0].value[0]
#define GETDESKTOPDISPLAYMODE_W num_var[1].nid_value[0].value[0]
#define GETDESKTOPDISPLAYMODE_H num_var[2].nid_value[0].value[0]
#define GETDESKTOPDISPLAYMODE_FREQ num_var[3].nid_value[0].value[0]
#define FN_DrawImage_Transform 338
#define DRAWIMAGE_TRANSFORM_SLOT num_var[0].nid_value[0].value[0]
#define DRAWIMAGE_TRANSFORM_X num_var[1].nid_value[0].value[0]
#define DRAWIMAGE_TRANSFORM_Y num_var[2].nid_value[0].value[0]
#define DRAWIMAGE_TRANSFORM_W num_var[3].nid_value[0].value[0]
#define DRAWIMAGE_TRANSFORM_H num_var[4].nid_value[0].value[0]
#define DRAWIMAGE_TRANSFORM_SRC_X num_var[5].nid_value[0].value[0]
#define DRAWIMAGE_TRANSFORM_SRC_Y num_var[6].nid_value[0].value[0]
#define DRAWIMAGE_TRANSFORM_SRC_W num_var[7].nid_value[0].value[0]
#define DRAWIMAGE_TRANSFORM_SRC_H num_var[8].nid_value[0].value[0]
#define DRAWIMAGE_TRANSFORM_ANGLE num_var[9].nid_value[0].value[0]
#define DRAWIMAGE_TRANSFORM_CENTER_X num_var[10].nid_value[0].value[0]
#define DRAWIMAGE_TRANSFORM_CENTER_Y num_var[11].nid_value[0].value[0]
#define DRAWIMAGE_TRANSFORM_FLIP_H num_var[12].nid_value[0].value[0]
#define DRAWIMAGE_TRANSFORM_FLIP_V num_var[13].nid_value[0].value[0]
#define FN_GetPowerInfo 339
#define GETPOWERINFO_STATUS num_var[0].nid_value[0].value[0]
#define GETPOWERINFO_SECS num_var[1].nid_value[0].value[0]
#define GETPOWERINFO_PCT num_var[2].nid_value[0].value[0]
#define FN_SystemRam 340
#define FN_SetRenderScaleQuality 341
#define SETRENDERSCALEQUALITY_N num_var[0].nid_value[0].value[0]
#define FN_EvalJS$ 342
#define EVALJS$_JS_CODE$ str_var[0].sid_value[0].value[0]
#define FN_GetRenderScaleQuality 343
#define FN_WindowOpen_Ex 344
#define WINDOWOPEN_EX_WIN num_var[0].nid_value[0].value[0]
#define WINDOWOPEN_EX_TITLE$ str_var[0].sid_value[0].value[0]
#define WINDOWOPEN_EX_X num_var[1].nid_value[0].value[0]
#define WINDOWOPEN_EX_Y num_var[2].nid_value[0].value[0]
#define WINDOWOPEN_EX_W num_var[3].nid_value[0].value[0]
#define WINDOWOPEN_EX_H num_var[4].nid_value[0].value[0]
#define WINDOWOPEN_EX_FLAG num_var[5].nid_value[0].value[0]
#define WINDOWOPEN_EX_VSYNC num_var[6].nid_value[0].value[0]
#define FN_GetGlobalMouse 345
#define GETGLOBALMOUSE_X num_var[0].nid_value[0].value[0]
#define GETGLOBALMOUSE_Y num_var[1].nid_value[0].value[0]
#define GETGLOBALMOUSE_MB1 num_var[2].nid_value[0].value[0]
#define GETGLOBALMOUSE_MB2 num_var[3].nid_value[0].value[0]
#define GETGLOBALMOUSE_MB3 num_var[4].nid_value[0].value[0]
#define FN_GlobalMouseX 346
#define FN_GlobalMouseY 347
#define FN_GetAccel 348
#define GETACCEL_ACCEL_NUM num_var[0].nid_value[0].value[0]
#define GETACCEL_X num_var[1].nid_value[0].value[0]
#define GETACCEL_Y num_var[2].nid_value[0].value[0]
#define GETACCEL_Z num_var[3].nid_value[0].value[0]
#define FN_AccelName$ 349
#define ACCELNAME$_ACCEL_NUM num_var[0].nid_value[0].value[0]
#define FN_NumAccels 350
#define FN_GetGyro 351
#define GETGYRO_GYRO_NUM num_var[0].nid_value[0].value[0]
#define GETGYRO_X num_var[1].nid_value[0].value[0]
#define GETGYRO_Y num_var[2].nid_value[0].value[0]
#define GETGYRO_Z num_var[3].nid_value[0].value[0]
#define FN_GyroName$ 352
#define GYRONAME$_GYRO_NUM num_var[0].nid_value[0].value[0]
#define FN_NumGyros 353
#define FN_JoyRumblePlay 354
#define JOYRUMBLEPLAY_JOY_NUM num_var[0].nid_value[0].value[0]
#define JOYRUMBLEPLAY_STRENGTH num_var[1].nid_value[0].value[0]
#define JOYRUMBLEPLAY_DURATION num_var[2].nid_value[0].value[0]
#define FN_JoyRumbleStop 355
#define JOYRUMBLESTOP_JOY_NUM num_var[0].nid_value[0].value[0]
