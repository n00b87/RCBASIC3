...
#define GETPROJECTIONGEOMETRY_CAM_DIST num_var[0].nid_value[0].value[ num_var[0].byref_offset ]
#define GETPROJECTIONGEOMETRY_MA num_var[1].nid_value[0].value[ num_var[1].byref_offset ]
#define GETPROJECTIONGEOMETRY_F_VERTEX_COUNT num_var[2].nid_value[0].value[ num_var[2].byref_offset ]
#define GETPROJECTIONGEOMETRY_COLUMNS num_var[3].nid_value[0].value[ num_var[3].byref_offset ]
#define GETPROJECTIONGEOMETRY_UV num_var[4].nid_value[0].value[ num_var[4].byref_offset ]
#define GETPROJECTIONGEOMETRY_GRAPH_OFFSET_X num_var[5].nid_value[0].value[ num_var[5].byref_offset ]
#define GETPROJECTIONGEOMETRY_GRAPH_OFFSET_Y num_var[6].nid_value[0].value[ num_var[6].byref_offset ]
#define GETPROJECTIONGEOMETRY_V_COLOR num_var[7].nid_value[0].value[ num_var[7].byref_offset ]
#define GETPROJECTIONGEOMETRY_VERTEX_COUNT num_var[8].nid_value[0].value[ num_var[8].byref_offset ]
#define GETPROJECTIONGEOMETRY_VERTEX2D num_var[9].nid_value[0].value[ num_var[9].byref_offset ]
#define GETPROJECTIONGEOMETRY_INDEX_COUNT num_var[10].nid_value[0].value[ num_var[10].byref_offset ]
#define GETPROJECTIONGEOMETRY_INDEX num_var[11].nid_value[0].value[ num_var[11].byref_offset ]
#define GETPROJECTIONGEOMETRY_CLIP_DIST num_var[12].nid_value[0].value[ num_var[12].byref_offset ]
#define GETPROJECTIONGEOMETRY_MIN_X num_var[13].nid_value[0].value[ num_var[13].byref_offset ]
#define GETPROJECTIONGEOMETRY_MIN_Y num_var[14].nid_value[0].value[ num_var[14].byref_offset ]
#define GETPROJECTIONGEOMETRY_MAX_X num_var[15].nid_value[0].value[ num_var[15].byref_offset ]
#define GETPROJECTIONGEOMETRY_MAX_Y num_var[16].nid_value[0].value[ num_var[16].byref_offset ]
#define FN_CalculateFaceZ 453
#define CALCULATEFACEZ_CAM_DIST num_var[0].nid_value[0].value[ num_var[0].byref_offset ]
#define CALCULATEFACEZ_GRAPH_OFFSET_X num_var[1].nid_value[0].value[ num_var[1].byref_offset ]
#define CALCULATEFACEZ_GRAPH_OFFSET_Y num_var[2].nid_value[0].value[ num_var[2].byref_offset ]
#define CALCULATEFACEZ_VIEW_W num_var[3].nid_value[0].value[ num_var[3].byref_offset ]
#define CALCULATEFACEZ_VIEW_H num_var[4].nid_value[0].value[ num_var[4].byref_offset ]
#define CALCULATEFACEZ_VIEW_DEPTH num_var[5].nid_value[0].value[ num_var[5].byref_offset ]
#define CALCULATEFACEZ_MA num_var[6].nid_value[0].value[ num_var[6].byref_offset ]
#define CALCULATEFACEZ_F_VERTEX_COUNT num_var[7].nid_value[0].value[ num_var[7].byref_offset ]
#define CALCULATEFACEZ_COLUMNS num_var[8].nid_value[0].value[ num_var[8].byref_offset ]
#define CALCULATEFACEZ_FACE_MIN_Z num_var[9].nid_value[0].value[ num_var[9].byref_offset ]
#define CALCULATEFACEZ_FACE_MAX_Z num_var[10].nid_value[0].value[ num_var[10].byref_offset ]
#define CALCULATEFACEZ_Z_AVG num_var[11].nid_value[0].value[ num_var[11].byref_offset ]
#define FN_SetChannelSpacePosition 454
#define SETCHANNELSPACEPOSITION_CHANNEL num_var[0].nid_value[0].value[ num_var[0].byref_offset ]
#define SETCHANNELSPACEPOSITION_ANGLE num_var[1].nid_value[0].value[ num_var[1].byref_offset ]
#define SETCHANNELSPACEPOSITION_DISTANCE num_var[2].nid_value[0].value[ num_var[2].byref_offset ]
#define FN_SaveBMP 455
#define SAVEBMP_IMG num_var[0].nid_value[0].value[ num_var[0].byref_offset ]
#define SAVEBMP_FILE$ str_var[0].sid_value[0].value[ str_var[0].byref_offset ]
#define FN_SavePNG 456
#define SAVEPNG_IMG num_var[0].nid_value[0].value[ num_var[0].byref_offset ]
#define SAVEPNG_FILE$ str_var[0].sid_value[0].value[ str_var[0].byref_offset ]
#define FN_SaveJPG 457
#define SAVEJPG_IMG num_var[0].nid_value[0].value[ num_var[0].byref_offset ]
#define SAVEJPG_FILE$ str_var[0].sid_value[0].value[ str_var[0].byref_offset ]
#define FN_GetLineIntersection 458
#define GETLINEINTERSECTION_P0_X num_var[0].nid_value[0].value[ num_var[0].byref_offset ]
#define GETLINEINTERSECTION_P0_Y num_var[1].nid_value[0].value[ num_var[1].byref_offset ]
#define GETLINEINTERSECTION_P1_X num_var[2].nid_value[0].value[ num_var[2].byref_offset ]
#define GETLINEINTERSECTION_P1_Y num_var[3].nid_value[0].value[ num_var[3].byref_offset ]
#define GETLINEINTERSECTION_P2_X num_var[4].nid_value[0].value[ num_var[4].byref_offset ]
#define GETLINEINTERSECTION_P2_Y num_var[5].nid_value[0].value[ num_var[5].byref_offset ]
#define GETLINEINTERSECTION_P3_X num_var[6].nid_value[0].value[ num_var[6].byref_offset ]
#define GETLINEINTERSECTION_P3_Y num_var[7].nid_value[0].value[ num_var[7].byref_offset ]
#define GETLINEINTERSECTION_I_X num_var[8].nid_value[0].value[ num_var[8].byref_offset ]
#define GETLINEINTERSECTION_I_Y num_var[9].nid_value[0].value[ num_var[9].byref_offset ]
#define FN_Interpolate 459
#define INTERPOLATE_MIN_A num_var[0].nid_value[0].value[ num_var[0].byref_offset ]
#define INTERPOLATE_MAX_A num_var[1].nid_value[0].value[ num_var[1].byref_offset ]
#define INTERPOLATE_MID_A num_var[2].nid_value[0].value[ num_var[2].byref_offset ]
#define INTERPOLATE_MIN_B num_var[3].nid_value[0].value[ num_var[3].byref_offset ]
#define INTERPOLATE_MAX_B num_var[4].nid_value[0].value[ num_var[4].byref_offset ]
#define FN_ATan2 460
#define ATAN2_Y num_var[0].nid_value[0].value[ num_var[0].byref_offset ]
#define ATAN2_X num_var[1].nid_value[0].value[ num_var[1].byref_offset ]
#define FN_PointInQuad 461
#define POINTINQUAD_X num_var[0].nid_value[0].value[ num_var[0].byref_offset ]
#define POINTINQUAD_Y num_var[1].nid_value[0].value[ num_var[1].byref_offset ]
#define POINTINQUAD_X1 num_var[2].nid_value[0].value[ num_var[2].byref_offset ]
#define POINTINQUAD_Y1 num_var[3].nid_value[0].value[ num_var[3].byref_offset ]
#define POINTINQUAD_X2 num_var[4].nid_value[0].value[ num_var[4].byref_offset ]
#define POINTINQUAD_Y2 num_var[5].nid_value[0].value[ num_var[5].byref_offset ]
#define POINTINQUAD_X3 num_var[6].nid_value[0].value[ num_var[6].byref_offset ]
#define POINTINQUAD_Y3 num_var[7].nid_value[0].value[ num_var[7].byref_offset ]
#define POINTINQUAD_X4 num_var[8].nid_value[0].value[ num_var[8].byref_offset ]
#define POINTINQUAD_Y4 num_var[9].nid_value[0].value[ num_var[9].byref_offset ]
#define FN_PointInTri 462
#define POINTINTRI_X num_var[0].nid_value[0].value[ num_var[0].byref_offset ]
#define POINTINTRI_Y num_var[1].nid_value[0].value[ num_var[1].byref_offset ]
#define POINTINTRI_X1 num_var[2].nid_value[0].value[ num_var[2].byref_offset ]
#define POINTINTRI_Y1 num_var[3].nid_value[0].value[ num_var[3].byref_offset ]
#define POINTINTRI_X2 num_var[4].nid_value[0].value[ num_var[4].byref_offset ]
#define POINTINTRI_Y2 num_var[5].nid_value[0].value[ num_var[5].byref_offset ]
#define POINTINTRI_X3 num_var[6].nid_value[0].value[ num_var[6].byref_offset ]
#define POINTINTRI_Y3 num_var[7].nid_value[0].value[ num_var[7].byref_offset ]
#define FN_Distance2D 463
#define DISTANCE2D_X1 num_var[0].nid_value[0].value[ num_var[0].byref_offset ]
#define DISTANCE2D_Y1 num_var[1].nid_value[0].value[ num_var[1].byref_offset ]
#define DISTANCE2D_X2 num_var[2].nid_value[0].value[ num_var[2].byref_offset ]
#define DISTANCE2D_Y2 num_var[3].nid_value[0].value[ num_var[3].byref_offset ]
#define FN_Distance3D 464
#define DISTANCE3D_X1 num_var[0].nid_value[0].value[ num_var[0].byref_offset ]
#define DISTANCE3D_Y1 num_var[1].nid_value[0].value[ num_var[1].byref_offset ]
#define DISTANCE3D_Z1 num_var[2].nid_value[0].value[ num_var[2].byref_offset ]
#define DISTANCE3D_X2 num_var[3].nid_value[0].value[ num_var[3].byref_offset ]
#define DISTANCE3D_Y2 num_var[4].nid_value[0].value[ num_var[4].byref_offset ]
#define DISTANCE3D_Z2 num_var[5].nid_value[0].value[ num_var[5].byref_offset ]
#define FN_GetCircleLineIntersection 465
#define GETCIRCLELINEINTERSECTION_CIRCLE_X num_var[0].nid_value[0].value[ num_var[0].byref_offset ]
#define GETCIRCLELINEINTERSECTION_CIRCLE_Y num_var[1].nid_value[0].value[ num_var[1].byref_offset ]
#define GETCIRCLELINEINTERSECTION_RADIUS num_var[2].nid_value[0].value[ num_var[2].byref_offset ]
#define GETCIRCLELINEINTERSECTION_X1 num_var[3].nid_value[0].value[ num_var[3].byref_offset ]
#define GETCIRCLELINEINTERSECTION_Y1 num_var[4].nid_value[0].value[ num_var[4].byref_offset ]
#define GETCIRCLELINEINTERSECTION_X2 num_var[5].nid_value[0].value[ num_var[5].byref_offset ]
#define GETCIRCLELINEINTERSECTION_Y2 num_var[6].nid_value[0].value[ num_var[6].byref_offset ]
#define GETCIRCLELINEINTERSECTION_IX1 num_var[7].nid_value[0].value[ num_var[7].byref_offset ]
#define GETCIRCLELINEINTERSECTION_IY1 num_var[8].nid_value[0].value[ num_var[8].byref_offset ]
#define GETCIRCLELINEINTERSECTION_IX2 num_var[9].nid_value[0].value[ num_var[9].byref_offset ]
#define GETCIRCLELINEINTERSECTION_IY2 num_var[10].nid_value[0].value[ num_var[10].byref_offset ]
#define FN_GetLinePlaneIntersection 466
#define GETLINEPLANEINTERSECTION_LINE_POINT num_var[0].nid_value[0].value[ num_var[0].byref_offset ]
#define GETLINEPLANEINTERSECTION_LINE_DIRECTION num_var[1].nid_value[0].value[ num_var[1].byref_offset ]
#define GETLINEPLANEINTERSECTION_PLANE_POINT_1 num_var[2].nid_value[0].value[ num_var[2].byref_offset ]
#define GETLINEPLANEINTERSECTION_PLANE_POINT_2 num_var[3].nid_value[0].value[ num_var[3].byref_offset ]
#define GETLINEPLANEINTERSECTION_PLANE_POINT_3 num_var[4].nid_value[0].value[ num_var[4].byref_offset ]
#define GETLINEPLANEINTERSECTION_INTERSECTION num_var[5].nid_value[0].value[ num_var[5].byref_offset ]
#define FN_IncrementMatrixRows 467
#define INCREMENTMATRIXROWS_MA num_var[0].nid_value[0].value[ num_var[0].byref_offset ]
#define INCREMENTMATRIXROWS_MB num_var[1].nid_value[0].value[ num_var[1].byref_offset ]
#define INCREMENTMATRIXROWS_R num_var[2].nid_value[0].value[ num_var[2].byref_offset ]
#define INCREMENTMATRIXROWS_NUM_ROWS num_var[3].nid_value[0].value[ num_var[3].byref_offset ]
#define INCREMENTMATRIXROWS_VALUE num_var[4].nid_value[0].value[ num_var[4].byref_offset ]
#define FN_IncrementMatrixColumns 468
#define INCREMENTMATRIXCOLUMNS_MA num_var[0].nid_value[0].value[ num_var[0].byref_offset ]
#define INCREMENTMATRIXCOLUMNS_MB num_var[1].nid_value[0].value[ num_var[1].byref_offset ]
#define INCREMENTMATRIXCOLUMNS_C num_var[2].nid_value[0].value[ num_var[2].byref_offset ]
#define INCREMENTMATRIXCOLUMNS_NUM_COLS num_var[3].nid_value[0].value[ num_var[3].byref_offset ]
#define INCREMENTMATRIXCOLUMNS_VALUE num_var[4].nid_value[0].value[ num_var[4].byref_offset ]
#define FN_JoinMatrixRows 469
#define JOINMATRIXROWS_MA num_var[0].nid_value[0].value[ num_var[0].byref_offset ]
#define JOINMATRIXROWS_MB num_var[1].nid_value[0].value[ num_var[1].byref_offset ]
#define JOINMATRIXROWS_MC num_var[2].nid_value[0].value[ num_var[2].byref_offset ]
#define FN_JoinMatrixColumns 470
#define JOINMATRIXCOLUMNS_MA num_var[0].nid_value[0].value[ num_var[0].byref_offset ]
#define JOINMATRIXCOLUMNS_MB num_var[1].nid_value[0].value[ num_var[1].byref_offset ]
#define JOINMATRIXCOLUMNS_MC num_var[2].nid_value[0].value[ num_var[2].byref_offset ]
