...
call windres.exe -I%WX_HOME%\include  -J rc -O coff -i resource.rc ^
...
call gcc.exe -Wall -fexceptions -O2 %INCLUDE_64_PATH% ^
...
call g++.exe -Wall -fexceptions -O2 %INCLUDE_64_PATH% ^
                                -c main.cpp ^
